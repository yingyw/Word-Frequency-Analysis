...
public abstract class DataCounter<E> {
     ...
     */
    public abstract int getCount(E data);
     ...
     */
    public abstract SimpleIterator<DataCount<E>> getIterator();
    
    /**
     * @return string representation of the DataCounter, as the order returned by its iterator
     */
